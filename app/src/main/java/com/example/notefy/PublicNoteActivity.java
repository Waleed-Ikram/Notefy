...
public class PublicNoteActivity extends AppCompatActivity {
    ...
    PublicNotesAdapter notesAdapter;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        EdgeToEdge.enable(this);
        setContentView(R.layout.publicnoteactivity);
    ...
    {
        Intent i = new Intent(PublicNoteActivity.this, AddPublicNote.class);
        startActivity(i);
        finish();
    ...
    private void init()
    {
        ...
        FirebaseRecyclerOptions<PublicNote> options =
                new FirebaseRecyclerOptions.Builder<PublicNote>()
                        ...
                        .build();
        notesAdapter = new PublicNotesAdapter(this, options);
